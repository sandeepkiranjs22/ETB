...
if __name__ == '__main__':
    ...
    loan_file = './data/processed/loan_upsell_processed.csv'
    ...
    """target column"""
    y_loan = loan_obj.label_encoding(loan_df['loan_availed2'])
    ...
    for i in range(len(y_loan)):
        loan_dict[y_loan[i]] = loan_df['loan_availed2'][i]
    print(loan_dict)

    loan_ddf = loan_ddf.drop('loan_availed2', axis=1)
    ...
    print("loan upsell model trained")
    print()
    ...
    print("Loan Upsell Model Accuracy - ", loan_model_accuracy)
    ...
    customer_df['loan_upsell_top3_reco'] = loan_top3_recommendations
    print(customer_df.head())
    customer_df.to_csv('./reco_results/loan_upsell_test_set_recommendations.csv', index=False)